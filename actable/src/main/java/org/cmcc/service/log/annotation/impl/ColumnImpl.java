package org.cmcc.service.log.annotation.impl;

import org.cmcc.service.log.annotation.Column;
import org.cmcc.service.log.constants.MySqlTypeConstant;
import org.cmcc.service.log.utils.ColumnUtils;
...
public class ColumnImpl implements Column {
     ...
     * 不填默认转换类：org.cmcc.service.log.command.JavaToMysqlType
     * 1.3.0版本支持，也可通过注解实现：org.cmcc.service.log.annotation.ColumnType
     *
     * @return 字段类型
     */
    @Override
    ...
    /**
     * 字段长度，默认是255
     * 类型默认长度参考：org.cmcc.service.log.constants.MySqlTypeConstant
     ...
     * 也可通过注解实现：org.cmcc.service.log.annotation.IsNotNull
    ...
    /**
     * 是否是主键，默认false
     * 也可通过注解实现：org.cmcc.service.log.annotation.IsKey
    ...
    /**
     * 是否自动递增，默认false
     * 也可通过注解实现：org.cmcc.service.log.annotation.IsAutoIncrement
     *
    ...
    /**
     * 默认值，默认为null
     * 1.3.0版本支持，也可通过注解实现：org.cmcc.service.log.annotation.DefaultValue
     *
     * @return 默认值
     */
    @Override
...
//    }
    ...
    /**
     * 数据表字段备注
     * 1.3.0版本支持，也可通过注解实现：org.cmcc.service.log.annotation.Comment
     *
     * @return 默认值，默认为空
     */
    @Override
