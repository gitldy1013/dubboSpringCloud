package org.cmcc.service.log.manager.common;

import org.cmcc.service.log.command.PageResultCommand;
import org.cmcc.service.log.command.SaveOrUpdateDataCommand;
import org.cmcc.service.log.dao.common.BaseCRUDMapper;
import org.cmcc.service.log.utils.ColumnUtils;
import org.cmcc.service.log.utils.FieldUtils;
...
public class BaseCRUDManagerImpl implements BaseCRUDManager {
     ...
     * 根据实体对象的非Null字段作为Where条件查询结果集，如果对象的属性值都为null则返回全部数据等同于selectAll+分页
     *
     * @param t 实体对象(如果要支持分页实体对象可以继承org.cmcc.service.log.command.BaseModel)
